...
# Step 2: Smooth
gx_smooth, gy_smooth = grid.lagrangian_smooth_grid(gx, gy, weight_self=0.9, iterations=20)
grid.plot_grid(gx_smooth, gy_smooth, ax=axes[2], title="Smooth the filtered grid",label_parameters=True)
